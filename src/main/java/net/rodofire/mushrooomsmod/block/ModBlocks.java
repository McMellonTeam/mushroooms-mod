...
public class ModBlocks {
    ...
    public static final Block BLUE_MUSHROOM = registerBlock("mushroom_blue", new MushroomPlantBlock(ModConfiguredFeatures.BLUE_MUSHROOM_TREE_KEY_OTH, FabricBlockSettings.copyOf(Blocks.RED_MUSHROOM)));
    ...
    public static final Block ORANGE_MUSHROOM = registerBlock("mushroom_orange", new MushroomPlantBlock(ModConfiguredFeatures.ORANGE_MUSHROOM_TREE_KEY_OTH, FabricBlockSettings.copyOf(Blocks.RED_MUSHROOM)));
    public static final Block YELLOW_MUSHROOM = registerBlock("mushroom_yellow", new MushroomPlantBlock(ModConfiguredFeatures.YELLOW_MUSHROOM_TREE_KEY_OTH, FabricBlockSettings.copyOf(Blocks.RED_MUSHROOM).luminance(5)));
    ...
    public static final Block MUSHROOM_FLOWERS = registerBlock("mushroom_flowers", new FlowersMushroomBlock(ModConfiguredFeatures.BIG_PURPLE_MUSHROOM_TREE_KEY_OTH, FabricBlockSettings.copyOf(Blocks.TALL_GRASS).nonOpaque().noCollision()));
    ...
    public static final Block PELTOGYNE_TRAPDOOR = registerBlock("trapdoor_peltogyne", new TrapdoorBlock(BlockSetType.OAK, FabricBlockSettings.copyOf(Blocks.OAK_TRAPDOOR)));

    public static final Block BLUE_LUMINESCENT_DOOR = registerBlock("door_blue_luminescent", new DoorBlock(BlockSetType.OAK, FabricBlockSettings.copyOf(Blocks.OAK_TRAPDOOR)));
    public static final Block PELTOGYNE_DOOR = registerBlock("door_peltogyne", new DoorBlock(BlockSetType.OAK, FabricBlockSettings.copyOf(Blocks.OAK_TRAPDOOR)));
    ...
    public static final Block PELTOGYNE_BUTTON = registerBlock("button_peltogyne", new ButtonBlock(BlockSetType.OAK, 20, FabricBlockSettings.copyOf(Blocks.OAK_BUTTON)));
    ...
    public static final Block PELTOGYNE_PRESSURE_PLATE = registerBlock("pressure_plate_peltogyne", new PressurePlateBlock(BlockSetType.OAK, FabricBlockSettings.copyOf(Blocks.OAK_PRESSURE_PLATE)));
    ...
    public static final Block PELTOGYNE_FENCE_GATE = registerBlock("fence_gate_peltogyne", new FenceGateBlock(WoodType.OAK, FabricBlockSettings.copyOf(Blocks.OAK_FENCE_GATE)));

    public static final Block COLORFUL_TREE_SAPLING = registerBlock("sapling_colorful_tree", new SaplingBlock(ModSaplings.COLORFUL_TREE_SAPLING_GENERATOR, FabricBlockSettings.copyOf(Blocks.OAK_SAPLING)));
    ...
    public static final Block PELTOGYNE_SAPLING = registerBlock("sapling_peltogyne", new SaplingBlock(ModSaplings.PELTOGYNE_SAPLING_GENERATOR, FabricBlockSettings.copyOf(Blocks.OAK_SAPLING)));
