...
public class MediumGreenMushroom extends BigMushroom implements Fertilizable {
    private final RegistryKey<ConfiguredFeature<?, ?>> featureKey;

    public MediumGreenMushroom(Settings settings, RegistryKey<ConfiguredFeature<?, ?>> featureKey) {
        super(settings);
        this.featureKey = featureKey;
    }

    public static final VoxelShape SHAPE = Block.createCuboidShape(0f, 0f, 0f, 16f, 14f, 16f);
