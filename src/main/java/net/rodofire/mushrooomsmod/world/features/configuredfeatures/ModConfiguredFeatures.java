...
public class ModConfiguredFeatures<FC extends FeatureConfig> {
    ...
    public static final RegistryKey<ConfiguredFeature<?, ?>> BIG_PURPLE_MUSHROOM_TREE_KEY = registerKey("big_purple_mushroom_tre_key");
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, BIG_PURPLE_MUSHROOM_TREE_KEY, ModFeatures.HUGE_BIG_PURPLE_MUSHROOM_OTH, new PurpleMushroomConfig(12, 26, 2, 6));
        ...
        register(context, YELLOW_MUSHROOM_TREE_KEY, ModFeatures.HUGE_YELLOW_MUSHROOM, new HugeMushroomFeatureConfig(BlockStateProvider.of(ModBlocks.YELLOW_MUSHROOM_BLOCK), BlockStateProvider.of(Blocks.MUSHROOM_STEM), 4));
        register(context, ORANGE_MUSHROOM_TREE_KEY, ModFeatures.HUGE_BIG_ORANGE_MUSHROOM, new DefaultFeatureConfig());
