...
public class CustomYellowMushroomFeature extends CustomYellowMushroom {
    ...
    protected Integer[] generateHugeTrunk(StructureWorldAccess world, Random random, BlockPos pos, BlockPos.Mutable mutable, int height, HugeMushroomFeatureConfig config, int randomx, int randomz, double phi, double theta) {
        ...
        int randomn1 = Random.create().nextBetween(1, (int) Math.abs((float) phi * 3));
        int randomn2 = Random.create().nextBetween(1, (int) Math.abs((float) phi * 3));
        int randomn3 = Random.create().nextBetween(1, (int) Math.abs((float) phi * 3));
        int randomn4 = Random.create().nextBetween(1, (int) Math.abs((float) phi * 3));
        int randomn5 = Random.create().nextBetween(1, (int) Math.abs((float) phi * 3));
        int randomn6 = Random.create().nextBetween(1, (int) Math.abs((float) phi * 3));
        int randomn7 = Random.create().nextBetween(1, (int) Math.abs((float) phi * 3));
        int randomn8 = Random.create().nextBetween(1, (int) Math.abs((float) phi * 3));
