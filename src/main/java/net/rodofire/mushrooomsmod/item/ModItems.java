...
public class ModItems {
    ...
    //Disc
   // public static final Item HYMNE_FRANCAIS_MUSIC_DISC = registerItem("hymne_francais_music_disc", new Item(new Item.Settings().maxCount(1).jukeboxPlayable(ModSounds.LA_MARSEILLAISE_DISC), 80));
   // public static final Item HYMNE_URSS_MUSIC_DISC = registerItem("hymne_urss_music_disc", new Item(new Item.Settings().maxCount(1).jukeboxPlayable(ModSounds.HYMEN_URSS), 210));
