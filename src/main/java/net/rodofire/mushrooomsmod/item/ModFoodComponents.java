...
public class ModFoodComponents {
    ...
    public static final FoodComponent YELLOW_BERRIES = new FoodComponent.Builder().nutrition(1).saturationModifier(0.1f).alwaysEdible().build();
    public static final FoodComponent COOKED_YELLOW_BERRIES = new FoodComponent.Builder().nutrition(1).saturationModifier(0.2f).alwaysEdible().build();
}
