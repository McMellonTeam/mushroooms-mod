...
import net.louis.mushrooomsmod.block.PinkMushroomBlock.PinkMushroomVines;
...
public class BlueLuminescentVines extends Block implements Fertilizable {
    ...
    public void onBroken(WorldAccess world, BlockPos pos, BlockState state) {
        ...
        pos=pos.up();
        float f = MathHelper.nextBetween(world1.random, 0.8f, 1.2f);
        world.playSound(null, pos, SoundEvents.BLOCK_CAVE_VINES_PICK_BERRIES, SoundCategory.BLOCKS, 1.0f, f);
        while(world.getBlockState(pos).isOf(ModBlocks.CAERULEA_VOLUBILIS)){
            world.breakBlock(pos,true);
            Block.dropStack(world1, pos, new ItemStack(ModItems.CAERULEA_VOLUBILIS_ITEM, 1));
            pos = pos.up();
        }
        world.playSound(null, pos, SoundEvents.BLOCK_CAVE_VINES_PICK_BERRIES, SoundCategory.BLOCKS, 1.0f, f);
    }
