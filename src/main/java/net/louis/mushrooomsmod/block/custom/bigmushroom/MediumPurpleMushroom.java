...
public class MediumPurpleMushroom extends BigMushroom implements Fertilizable {
    private final RegistryKey<ConfiguredFeature<?, ?>> featureKey;
    public MediumPurpleMushroom(Settings settings,  RegistryKey<ConfiguredFeature<?, ?>> featureKey) {
        super(settings);
        this.featureKey=featureKey;
    }
    public static final VoxelShape SHAPE = Block.createCuboidShape(4f,0f,4f,12f,16f,12);
