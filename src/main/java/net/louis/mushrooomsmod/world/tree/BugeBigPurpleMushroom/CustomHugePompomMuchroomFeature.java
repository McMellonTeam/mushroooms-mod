...
public abstract class CustomHugePompomMuchroomFeature extends Feature<ModMushroomFeatureConfig> {
    public CustomHugePompomMuchroomFeature(Codec<ModMushroomFeatureConfig> codec) {
        super(codec);
    }
