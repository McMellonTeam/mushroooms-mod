package net.louis.mushrooomsmod.world.tree.HugeGreenMushroom;
...
public class HugeGreenMushroomFeature extends HugeMushroomFeature {

    public HugeGreenMushroomFeature(Codec<HugeMushroomFeatureConfig> codec) {
        super(codec);
    }
