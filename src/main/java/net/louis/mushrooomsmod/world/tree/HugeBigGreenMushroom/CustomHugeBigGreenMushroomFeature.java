...
public abstract class CustomHugeBigGreenMushroomFeature extends Feature<ModMushroomFeatureConfig> {
    public CustomHugeBigGreenMushroomFeature(Codec<ModMushroomFeatureConfig> configCodec) {
        super(configCodec);
    }
