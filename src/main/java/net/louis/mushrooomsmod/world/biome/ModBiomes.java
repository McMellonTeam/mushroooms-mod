...
public class ModBiomes {
    ...
    public static void bootstrap(Registerable<Biome> context){
        ...
        context.register(BLUE_LUMINESCENT_SHROOM_CAVE, blue_luminescent_shroom_cave(context));
    }
    ...
    public static Biome blue_luminescent_shroom_cave(Registerable<Biome> context) {
        SpawnSettings.Builder spawnBuilder = new SpawnSettings.Builder();
